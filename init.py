...
WS_name = 'Blade: Hi' # Weapon skill to test
shortname = "del" # Shortened weapon skill name. Used as filenames for output files


# Define upper and lower TP limits. Must remain as a list with at least 1 entry.
tp1_list = [1000] # Minimum TP values to check
tp2_list = [1300] # Maximum TP values to check. Same length as "tp1_list"
