...
Kunimitsu = {'Name': 'Kunimitsu', 'Name2': 'Kunimitsu R25', 'Skill Type': 'Katana', 'Type':'Weapon', 'DMG':151+11, 'Delay':227, 'DEX':15, 'AGI':15, 'Accuracy':40+10, 'Attack':30+40, 'Ranged Accuracy':40, 'Magic Accuracy':40+10,'Magic Attack':20, 'Magic Damage':217, 'Store TP':5, 'Magic Accuracy Skill':248, 'Katana Skill': 248, 'Weaponskill Damage':5, 'Jobs':[]}
Kunimitsu30 = {'Name': 'Kunimitsu', 'Name2': 'Kunimitsu R30', 'Skill Type': 'Katana', 'Type':'Weapon', 'DMG':151+12, 'Delay':227, 'DEX':15, 'AGI':15, 'Accuracy':40+15, 'Attack':30+45, 'Ranged Accuracy':40, 'Magic Accuracy':40+15,'Magic Attack':20, 'Magic Damage':217, 'Store TP':5, 'Magic Accuracy Skill':248, 'Katana Skill': 248, 'Weaponskill Damage':5, 'Jobs':[]}
...
Nyame_Helm = {'Name': 'Nyame Helm', 'Name2': 'Nyame Helm R25 B', 'STR':26, 'DEX':25, 'VIT':24, 'AGI':23, 'INT':28, 'MND':26, 'CHR':24,'Accuracy':40,'Attack':30+30, 'Gear Haste':6,'Weaponskill Damage':0+10,"DA":0+4,'Magic Accuracy':40,'Magic Attack':30,'Ranged Accuracy':40,'Ranged Attack':30+30,'Jobs':[]}
Nyame_Helm30 = {'Name': 'Nyame Helm', 'Name2': 'Nyame Helm R30 B', 'STR':26, 'DEX':25, 'VIT':24, 'AGI':23, 'INT':28, 'MND':26, 'CHR':24,'Accuracy':40,'Attack':30+35, 'Gear Haste':6,'Weaponskill Damage':0+11,"DA":0+5,'Magic Accuracy':40,'Magic Attack':30,'Ranged Accuracy':40,'Ranged Attack':30+35,'Jobs':[]}
...
Ryuo_Somen_A = {'Name': 'Ryuo Somen +1', 'Name2': 'Ryuo Somen +1 A', 'STR':21+12, 'DEX':17+12, 'VIT':14, 'AGI':20, 'INT':11, 'MND':11, 'CHR':11, 'Accuracy':35+20,'Ranged Accuracy':35,'Gear Haste':7,'Store TP':7,'Dual Wield':.09,'Jobs':[]}
...
Adhemar_Jacket_A = {'Name': 'Adhemar Jacket +1', 'Name2': 'Adhemar Jacket +1 A', 'STR':26, 'DEX':33+12, 'VIT':23, 'AGI':29+12, 'INT':20, 'MND':20, 'CHR':20, 'Accuracy':35+20, 'Attack':35, 'Ranged Accuracy':35, 'Ranged Attack':35, 'Gear Haste':4, "TA":4, 'Dual Wield':.06,'Jobs':[]}
Adhemar_Jacket_B = {'Name': 'Adhemar Jacket +1', 'Name2': 'Adhemar Jacket +1 B', 'STR':26+12, 'DEX':33+12, 'VIT':23, 'AGI':29, 'INT':20, 'MND':20, 'CHR':20, 'Accuracy':35, 'Attack':35+20, 'Ranged Accuracy':35, 'Ranged Attack':35, 'Gear Haste':4, "TA":4, 'Dual Wield':.06,'Jobs':[]}
...
Gyve_Doublet = {'Name': 'Gyve Doublet', 'STR':19, 'DEX':19, 'VIT':19, 'AGI':19, 'INT':39, 'MND':33, 'CHR':33, 'Magic Attack':42+10, 'Gear Haste':3,'Jobs':[]}
Hachiya_Chainmail = {'Name': 'Hachiya Chainmail +3', 'STR':39, 'DEX':35, 'VIT':36, 'AGI':35, 'INT':34, 'MND':34, 'CHR':34, 'Accuracy':50, 'Gear Haste':4,'Dual Wield':.1,'Crit Rate':8,'Jobs':[]}
...
Mochizuki_Chainmail = {'Name': 'Mochizuki Chainmail +3', 'STR':34, 'DEX':35, 'VIT':31, 'AGI':35, 'INT':34, 'MND':34, 'CHR':34, 'Accuracy':51, 'Attack':87, 'Ranged Accuracy':47, 'Ranged Attack':79, 'Magic Accuracy':40,'Gear Haste':4,'Dual Wield':.09,'Daken':10,'Jobs':[]}
...
Nyame_Mail = {'Name': 'Nyame Mail', 'Name2': 'Nyame Mail R25 B', 'STR':35, 'DEX':24, 'VIT':35, 'AGI':33, 'INT':42, 'MND':37, 'CHR':35, 'Accuracy':40, 'Attack':30+30, 'Gear Haste':3, 'Weaponskill Damage':0+12, 'Magic Accuracy':40, 'Magic Attack':30, 'Ranged Accuracy':40, 'Ranged Attack':30+30,"DA":0+5,'Jobs':[]}
Nyame_Mail30 = {'Name': 'Nyame Mail', 'Name2': 'Nyame Mail R30 B', 'STR':35, 'DEX':24, 'VIT':35, 'AGI':33, 'INT':42, 'MND':37, 'CHR':35, 'Accuracy':40, 'Attack':30+35, 'Gear Haste':3, 'Weaponskill Damage':0+13, 'Magic Accuracy':40, 'Magic Attack':30, 'Ranged Accuracy':40, 'Ranged Attack':30+35,"DA":0+7,'Jobs':[]}
...
Samnuha_Coat = {'Name': 'Samnuha Coat', 'STR':26, 'DEX':33, 'VIT':23, 'AGI':29, 'INT':20, 'MND':20, 'CHR':20, 'Accuracy':23, 'Magic Accuracy':23+15, 'Magic Attack':20+15, 'Gear Haste':4, 'Dual Wield':.05, 'Magic Burst Damage II': 8,'Jobs':[]}
...
Floral_Gauntlets = {'Name': 'Floral Gauntlets', 'STR':16, 'DEX':35,'VIT':29,'AGI':12,'INT':12,'MND':30,'CHR':17,'Accuracy':21+15,'Ranged Accuracy':21+15,'Gear Haste':5,'Dual Wield':.05,"TA":3, 'Jobs':[]}
...
Nyame_Gauntlets = {'Name': 'Nyame Gauntlets', 'Name2': 'Nyame Gauntlets R25 B', 'STR':17, 'DEX':42, 'VIT':39, 'AGI':12, 'INT':28, 'MND':40, 'CHR':24, 'Accuracy':40, 'Attack':30+30, 'Gear Haste':3, 'Weaponskill Damage':0+10, 'Magic Accuracy':40, 'Magic Attack':30, 'Ranged Accuracy':40, 'Ranged Attack':30+30,"DA":0+4, 'Jobs':[]}
Nyame_Gauntlets30 = {'Name': 'Nyame Gauntlets', 'Name2': 'Nyame Gauntlets R30 B', 'STR':17, 'DEX':42, 'VIT':39, 'AGI':12, 'INT':28, 'MND':40, 'CHR':24, 'Accuracy':40, 'Attack':30+35, 'Gear Haste':3, 'Weaponskill Damage':0+11, 'Magic Accuracy':40, 'Magic Attack':30, 'Ranged Accuracy':40, 'Ranged Attack':30+35,"DA":0+5, 'Jobs':[]}
...
Hachiya_Hakama = {'Name': 'Hachiya Hakama +3', 'STR':42, 'DEX':0, 'VIT':24, 'AGI':31, 'INT':42, 'MND':27, 'CHR':20, 'Accuracy':56, 'Ranged Accuracy':35, 'Gear Haste':6, 'Store TP':6, 'Dual Wield':.05,'Jobs':[]}
...
Mochizuki_Hakama = {'Name': 'Mochizuki Hakama +3', 'STR':42, 'DEX':0, 'VIT':24, 'AGI':36, 'INT':42, 'MND':27, 'CHR':20, 'Accuracy':39, 'Attack':64, 'Magic Accuracy':39, 'Gear Haste':6, "Dual Wield":.1, 'Weaponskill Damage':10,'Jobs':[]}
...
Nyame_Flanchard = {'Name': 'Nyame Flanchard', 'Name2': 'Nyame Flanchard R25 B', 'STR':43, 'DEX':0, 'VIT':30, 'AGI':34, 'INT':44, 'MND':32, 'CHR':24, 'Accuracy':40, 'Attack':30+30, 'Gear Haste':3, 'Weaponskill Damage':0+11, 'Magic Accuracy':40, 'Magic Attack':30, 'Ranged Accuracy':40, 'Ranged Attack':30+30,"DA":0+5,'Jobs':[]}
Nyame_Flanchard30 = {'Name': 'Nyame Flanchard', 'Name2': 'Nyame Flanchard R30 B', 'STR':43, 'DEX':0, 'VIT':30, 'AGI':34, 'INT':44, 'MND':32, 'CHR':24, 'Accuracy':40, 'Attack':30+35, 'Gear Haste':3, 'Weaponskill Damage':0+12, 'Magic Accuracy':40, 'Magic Attack':30, 'Ranged Accuracy':40, 'Ranged Attack':30+35,"DA":0+6,'Jobs':[]}
...
Hizamaru_Sune_Ate = {'Name': 'Hizamaru Sune-ate +2', 'STR':28, 'DEX':31, 'VIT':23, 'AGI':34, "INT":0, 'MND':3, 'CHR':28, 'Accuracy':42, 'Attack':24, 'Gear Haste':3, 'Dual Wield':.08, 'Jobs':[]}
...
Nyame_Sollerets = {'Name': 'Nyame Sollerets', 'Name2': 'Nyame Sollerets R25 B', 'STR':23, 'DEX':26, 'VIT':24, 'AGI':46, 'INT':25, 'MND':26, 'CHR':38, 'Accuracy':40, 'Attack':30+30, 'Gear Haste':3, 'Weaponskill Damage':0+10, 'Magic Accuracy':40, 'Magic Attack':30, 'Ranged Accuracy':40, 'Ranged Attack':30+30,"DA":0+4, 'Jobs':[]}
Nyame_Sollerets30 = {'Name': 'Nyame Sollerets', 'Name2': 'Nyame Sollerets R30 B', 'STR':23, 'DEX':26, 'VIT':24, 'AGI':46, 'INT':25, 'MND':26, 'CHR':38, 'Accuracy':40, 'Attack':30+35, 'Gear Haste':3, 'Weaponskill Damage':0+11, 'Magic Accuracy':40, 'Magic Attack':30, 'Ranged Accuracy':40, 'Ranged Attack':30+35,"DA":0+5, 'Jobs':[]}
...
# Confirm that all stats the gear being checked have correct stat names.
