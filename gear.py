...
Tsuru           = {'Name': 'Tsuru',            'Name2': 'Tsuru R30',             'Skill Type': 'Katana', 'Type':'Weapon', 'DMG':131, 'Delay':190,'VIT':15,'AGI':15,'Accuracy':40,'Ranged Accuracy':40, 'Katana Skill':242, 'Magic Accuracy Skill':242,'Daken':0.10, 'Jobs':[]}
...
Kunimitsu       = {'Name': 'Kunimitsu',        'Name2': 'Kunimitsu R30',         'Skill Type': 'Katana', 'Type':'Weapon', 'DMG':151+12, 'Delay':227, 'DEX':15, 'AGI':15, 'Accuracy':40+15, 'Attack':30+45, 'Ranged Accuracy':40, 'Magic Accuracy':40+15,'Magic Attack':20, 'Magic Damage':217, 'Store TP':5, 'Magic Accuracy Skill':248, 'Katana Skill': 248, 'Weaponskill Damage':0.05, 'Jobs':[]}
...
Gleti_Knife     = {'Name': "Gleti's Knife",    'Name2': "Gleti's Knife R30",     'Skill Type': 'Dagger', 'Type':'Weapon', 'DMG':133+11, 'Delay':200, 'DEX':15, 'AGI':15, 'Accuracy':40+15, 'Attack':30+45, 'Magic Accuracy':40+15, 'Dagger Skill':255, 'Magic Accuracy Skill':242,'Crit Rate':5,'TA':6, 'Jobs':[]}
Crepuscular_Knife = {'Name': 'Twilight Knife', 'Name2': 'Crepuscular Knife',     'Skill Type': 'Dagger', 'Type':'Weapon', 'DMG':133, 'Delay':190, 'DEX':15, 'AGI':15, 'CHR':15, 'Accuracy':40, 'Magic Accuracy':40, 'Dagger Skill':248, 'Magic Accuracy Skill':248, 'QA':5, 'Utu CHR':0.03, 'Jobs':[]}
...
Kraken_Club     = {'Name': 'Kraken Club',      'Name2': 'Kraken Club',           'Skill Type': 'Club',   'Type':'Weapon', 'DMG':11, 'Delay':264, 'OA2':0.15, 'OA3':0.25, 'OA4':0.25, 'OA5':0.15, 'OA6':0.10, 'OA7':0.03, 'OA8':0.02, 'Jobs':[]}
...
Amanomurakumo   = {'Name': 'Amanomurakumo',     'Name2': 'Amanomurakumo R15',      'Skill Type': 'Great Katana', 'Type':'Weapon', 'DMG': 308+18, 'Delay': 437, 'Accuracy': 60, 'Great Katana Skill': 269, 'Magic Accuracy Skill': 228, 'Store TP':10, 'Skillchain Bonus':0.05, 'Jobs':[]}
...
Tsuru           = {'Name': 'Tsuru',            'Name2': 'Tsuru R25',             'Skill Type': 'Katana', 'Type':'Weapon', 'DMG':131, 'Delay':190,'VIT':15,'AGI':15,'Accuracy':40,'Ranged Accuracy':40, 'Katana Skill':242, 'Magic Accuracy Skill':242,'Daken':0.08, 'Jobs':[]}
Kunimitsu       = {'Name': 'Kunimitsu',        'Name2': 'Kunimitsu R25',         'Skill Type': 'Katana', 'Type':'Weapon', 'DMG':151+11, 'Delay':227, 'DEX':15, 'AGI':15, 'Accuracy':40+10, 'Attack':30+40, 'Ranged Accuracy':40, 'Magic Accuracy':40+10,'Magic Attack':20, 'Magic Damage':217, 'Store TP':5, 'Magic Accuracy Skill':248, 'Katana Skill': 248, 'Weaponskill Damage':0.05, 'Jobs':[]}
...
Seething_Bomblet     = {'Name': 'Seething Bomblet +1',  'Name2': 'Seeth. Bomblet +1 R15', 'Accuracy':13, 'Attack':13, 'Magic Attack':7, 'STR':4+10, 'Haste':0+4, 'Jobs':[]}
...
Crepuscular_Pebble   = {'Name': 'Ghastly Tathlum', 'Name2': 'Crepuscular Pebble', 'STR':3, 'VIT':3, 'PDL':0.03, 'Jobs':[]}
...
Mochizuki_Hatsuburi = {'Name': 'Mochizuki Hatsuburi +3', 'STR':31, 'DEX':31, 'VIT':33, 'AGI':33, 'INT':32, 'MND':32, 'CHR':32, 'Accuracy':44,'Attack':62,'Magic Accuracy': 37, 'Magic Attack': 61, 'Haste': 8, 'Ninjutsu Magic Attack': 21,'Jobs':[]}
Ryuo_Somen_A        = {'Name': 'Ryuo Somen +1', 'Name2': 'Ryuo Somen +1 A', 'STR':21+12, 'DEX':17+12, 'VIT':14, 'AGI':20, 'INT':11, 'MND':11, 'CHR':11, 'Accuracy':35+20,'Ranged Accuracy':35,'Haste':7,'Store TP':7,'Dual Wield':.09,'Jobs':[]}
Malignance_Chapeau  = {'Name': 'Malignance Chapeau', 'STR':11,'DEX':40,'VIT':19,'AGI':33,'INT':25,'MND':16,'CHR':17,'Accuracy':50,'Ranged Accuracy':50,'Magic Accuracy':50,'Haste':6,'Store TP':8,'PDL':0.03,'Jobs':[]}
...
Mpaca_Cap         = {'Name': 'Mpaca\'s Cap', 'Name2': 'Mpaca\'s Cap R30', 'STR':33, 'DEX':30, 'VIT':26, 'AGI':24, 'INT':20, 'MND':17, 'CHR':20,'Accuracy':40+15,'Attack':40+30,'Magic Accuracy':40+15,'Haste':6,'TA':3,'Crit Rate':4,'TP Bonus':200,'Jobs':[]}
Nyame_Helm        = {'Name': 'Nyame Helm', 'Name2': 'Nyame Helm R30', 'STR':26, 'DEX':25, 'VIT':24, 'AGI':23, 'INT':28, 'MND':26, 'CHR':24,'Accuracy':40,'Attack':30+35, 'Haste':6,'Weaponskill Damage':0+0.11,'DA':0+5,'Magic Accuracy':40,'Magic Attack':30,'Ranged Accuracy':40,'Ranged Attack':30+35,'Jobs':[]}
...
Mpaca_Cap         = {'Name': 'Mpaca\'s Cap', 'Name2': 'Mpaca\'s Cap R25', 'STR':33, 'DEX':30, 'VIT':26, 'AGI':24, 'INT':20, 'MND':17, 'CHR':20,'Accuracy':40+10,'Attack':40+25,'Magic Accuracy':40+10,'Haste':6,'TA':3,'Crit Rate':4,'TP Bonus':200,'Jobs':[]}
Nyame_Helm        = {'Name': 'Nyame Helm', 'Name2': 'Nyame Helm R25', 'STR':26, 'DEX':25, 'VIT':24, 'AGI':23, 'INT':28, 'MND':26, 'CHR':24,'Accuracy':40,'Attack':30+30, 'Haste':6,'Weaponskill Damage':0+0.10,'DA':0+4,'Magic Accuracy':40,'Magic Attack':30,'Ranged Accuracy':40,'Ranged Attack':30+30,'Jobs':[]}
...
Ninja_Nodowa      = {'Name': 'Ninja Nodowa +2', 'Name2': 'Ninja Nodowa +2 R25', 'Accuracy': 25, 'Ranged Accuracy': 25, 'Store TP': 7, 'DEX':15, 'AGI':15, 'Daken':0.25, 'PDL':0.1, 'Jobs':['nin']}
...
Samurai_Nodowa    = {'Name': 'Samurai Nodowa +2', 'Name2':'Samurai Nodowa +2 R25', 'Accuracy':30, 'Store TP':14, 'STR':25, 'PDL':0.1, 'Jobs':['sam']}
...
Malignance_Tabard   = {'Name': 'Malignance Tabard', 'STR':19, 'DEX':49, 'VIT':25, 'AGI':42, 'INT':19, 'MND':24, 'CHR':24, 'Accuracy':50, 'Ranged Accuracy':50, 'Magic Accuracy':50, 'Haste':4, 'Store TP':11, 'PDL':0.06,'Jobs':[]}
Gyve_Doublet        = {'Name': 'Gyve Doublet', 'STR':19, 'DEX':19, 'VIT':19, 'AGI':19, 'INT':39, 'MND':33, 'CHR':33, 'Magic Attack':42+10, 'Haste':3,'Jobs':[]}
Herculean_Vest      = {'Name': 'Herculean Vest', 'STR':28, 'DEX':34, 'VIT':24, 'AGI':30, 'INT':21, 'MND':20, 'CHR':21, 'Accuracy':15, 'Ranged Accuracy':15, 'Haste':4, 'Store TP':3, 'Crit Rate':3,'Jobs':[]}
...
Mummu_Jacket        = {'Name': 'Mummu Jacket +2', 'STR':25, 'DEX':48, 'VIT':24, 'AGI':44, 'INT':21, 'MND':20, 'CHR':24, 'Accuracy':46, 'Ranged Accuracy':46, 'Magic Accuracy':46, 'Haste':4, 'Store TP':6, 'Crit Rate': 6,'Jobs':[]}
...
Nyame_Mail          = {'Name': 'Nyame Mail', 'Name2': 'Nyame Mail R30', 'STR':35, 'DEX':24, 'VIT':35, 'AGI':33, 'INT':42, 'MND':37, 'CHR':35, 'Accuracy':40, 'Attack':30+35, 'Haste':3, 'Weaponskill Damage':0+0.13, 'Magic Accuracy':40, 'Magic Attack':30, 'Ranged Accuracy':40, 'Ranged Attack':30+35,'DA':0+7,'Jobs':[]}
Mpaca_Doublet       = {'Name': "Mpaca's Doublet", 'Name2': "Mpaca's Doublet R30", 'STR':39, 'DEX':37, 'VIT':34, 'AGI':28, 'INT':28, 'MND':25, 'CHR':28,'Accuracy':40+15,'Attack':40+30,'Magic Accuracy':40+15,'Haste':4,'TA':4,'Crit Rate':7, 'Store TP':0+8,'Jobs':[]}
Tatenashi_Haramaki  = {'Name': 'Tatenashi Haramaki', 'Name2': 'Tatenashi Haramaki R15', 'STR':28+10, 'DEX':24+10, 'VIT':28+10, 'AGI':19+10, 'INT':19+10, 'MND':19+10, 'CHR':19+10,'Accuracy':35+30,'Attack':35,'Haste':3,'Crit Rate':6,'Store TP':8,'TA':0+5,'Jobs':[]}
...
Agony_Jerkin        = {'Name': 'Agony Jerkin +1', 'Name2': 'Agony Jerkin +1 R15', 'STR':24+10, 'DEX':35+10, 'VIT':24+10, 'AGI':28+10, 'INT':23+10, 'MND':23+10, 'CHR':23+10, 'Attack':23+60, 'Haste':4, 'Accuracy':14, 'Store TP':0+10,'Jobs':[]}
Sakonji_Domaru      = {'Name':'Sakonji Domaru +3', 'STR':42, 'DEX':37, 'VIT':36, 'AGI':31, 'INT':31, 'MND':31, 'CHR':31, 'Accuracy':47, 'Attack':80, 'Magic Accuracy':40, 'Haste':3, 'Store TP':10, 'Weaponskill Damage':0.1,'Jobs':[]}
Nyame_Mail          = {'Name': 'Nyame Mail', 'Name2': 'Nyame Mail R25', 'STR':35, 'DEX':24, 'VIT':35, 'AGI':33, 'INT':42, 'MND':37, 'CHR':35, 'Accuracy':40, 'Attack':30+30, 'Haste':3, 'Weaponskill Damage':0+0.12, 'Magic Accuracy':40, 'Magic Attack':30, 'Ranged Accuracy':40, 'Ranged Attack':30+30,'DA':0+5,'Jobs':[]}
Mpaca_Doublet       = {'Name': "Mpaca's Doublet", 'Name2': "Mpaca's Doublet R25", 'STR':39, 'DEX':37, 'VIT':34, 'AGI':28, 'INT':28, 'MND':25, 'CHR':28,'Accuracy':40+10,'Attack':40+25,'Magic Accuracy':40+10,'Haste':4,'TA':4,'Crit Rate':7, 'Store TP':0+7,'Jobs':[]}
...
Adhemar_Wristbands_A = {'Name': 'Adhemar Wristbands +1', 'Name2': 'Adhemar Wristbands +1 A', 'STR':15, 'DEX':44+12, 'VIT':29, 'AGI':7+12, 'INT':12, 'MND':30, 'CHR':17, 'Accuracy':32+20, 'Ranged Accuracy':32, 'TA':4, 'Store TP':7, 'Haste':5, 'Jobs':[]}
Adhemar_Wristbands_B = {'Name': 'Adhemar Wristbands +1', 'Name2': 'Adhemar Wristbands +1 B', 'STR':15+12, 'DEX':44+12, 'VIT':29, 'AGI':7, 'INT':12, 'MND':30, 'CHR':17, 'Accuracy':32, 'Ranged Accuracy':32, 'TA':4, 'Store TP':7, 'Attack':0+20, 'Haste':5, 'Jobs':[]}
...
Malignance_Gloves    = {'Name': 'Malignance Gloves', 'STR':25, 'DEX':56, 'VIT':32, 'AGI':24, 'INT':11, 'MND':42, 'CHR':21, 'Accuracy':50, 'Ranged Accuracy':50, 'Magic Accuracy':50, 'Haste':4,'Store TP':12,'PDL':0.04, 'Jobs':[]}
...
Nyame_Gauntlets      = {'Name': 'Nyame Gauntlets', 'Name2': 'Nyame Gauntlets R30', 'STR':17, 'DEX':42, 'VIT':39, 'AGI':12, 'INT':28, 'MND':40, 'CHR':24, 'Accuracy':40, 'Attack':30+35, 'Haste':3, 'Weaponskill Damage':0+0.11, 'Magic Accuracy':40, 'Magic Attack':30, 'Ranged Accuracy':40, 'Ranged Attack':30+35,'DA':0+5, 'Jobs':[]}
Mpaca_Gloves         = {'Name': "Mpaca's Gloves", 'Name2': "Mpaca's Gloves R30", "STR":20, "DEX":44,"VIT":38,"AGI":16,"INT":15,"MND":29,"CHR":25,"Accuracy":40+15,"Attack":40+30,"Magic Accuracy":40+15,'Haste':4,'TA':3,'Crit Rate':5, "TA DMG":0+10, 'Jobs':[]}
Tatenashi_Gote       = {'Name': 'Tatenashi Gote', 'Name2': 'Tatenashi Gote R15', 'STR':8+10, 'DEX':40+10, 'VIT':32+10, 'AGI':7+10, 'INT':6+10, 'MND':23+10, 'CHR':16+10,'Accuracy':21+40,'Haste':4,'Store TP':7,'TA':0+4, 'Jobs':[]}
...
Nyame_Gauntlets      = {'Name': 'Nyame Gauntlets', 'Name2': 'Nyame Gauntlets R25', 'STR':17, 'DEX':42, 'VIT':39, 'AGI':12, 'INT':28, 'MND':40, 'CHR':24, 'Accuracy':40, 'Attack':30+30, 'Haste':3, 'Weaponskill Damage':0+0.10, 'Magic Accuracy':40, 'Magic Attack':30, 'Ranged Accuracy':40, 'Ranged Attack':30+30,'DA':0+4, 'Jobs':[]}
Mpaca_Gloves         = {'Name': "Mpaca's Gloves", 'Name2': "Mpaca's Gloves R25", "STR":20, "DEX":44,"VIT":38,"AGI":16,"INT":15,"MND":29,"CHR":25,"Accuracy":40+10,"Attack":40+25,"Magic Accuracy":40+10,'Haste':4,'TA':3,'Crit Rate':5, "TA DMG":0+9, 'Jobs':[]}
...
Epaminondas_Ring = {'Name': "Epaminondas's Ring", 'Weaponskill Damage':0.05, 'Store TP':-10,'Jobs':[]}
...
Beithir_Ring     = {'Name': 'Beithir Ring', 'Name2': 'Beithir Ring R30', 'STR':3, 'DEX':3, 'VIT':3, 'AGI':3, 'Weaponskill Accuracy':0+15, 'Attack':0+15, 'Weaponskill Damage':0.02,'Jobs':[]}
...
Beithir_Ring     = {'Name': 'Beithir Ring', 'Name2': 'Beithir Ring R25', 'STR':3, 'DEX':3, 'VIT':3, 'AGI':3, 'Weaponskill Accuracy':0+15, 'Attack':0+10, 'Weaponskill Damage':0.02,'Jobs':[]}
...
Herculean_Trousers = {'Name': 'Herculean Trousers', 'STR':33, 'DEX':0, 'VIT':16, 'AGI':32, 'INT':29, 'MND':15, 'CHR':10, 'Attack':15, 'Ranged Attack':15,'Haste':6, 'Store TP':4,'Jobs':[]}
Adhemar_Kecks_A    = {'Name': 'Adhemar Kecks +1', 'Name2': 'Adhemar Kecks +1 A', 'STR':32, 'DEX':0+12, 'VIT':15, 'AGI':30+12, 'INT':28, 'MND':16, 'CHR':8, 'Accuracy':34+20, 'Ranged Accuracy':34, 'Haste':6, 'Store TP':8,'Jobs':[]}
Adhemar_Kecks_B    = {'Name': 'Adhemar Kecks +1', 'Name2': 'Adhemar Kecks +1 B', 'STR':32+12, 'DEX':0+12, 'VIT':15, 'AGI':30, 'INT':28, 'MND':16, 'CHR':8, 'Accuracy':34, 'Ranged Accuracy':34, 'Attack':20, 'Haste':6, 'Store TP':8,'Jobs':[]}
Hachiya_Hakama     = {'Name': 'Hachiya Hakama +3', 'STR':42, 'DEX':0, 'VIT':24, 'AGI':31, 'INT':42, 'MND':27, 'CHR':20, 'Accuracy':56, 'Ranged Accuracy':35, 'Haste':6, 'Store TP':6, 'Dual Wield':.05,'Jobs':[]}
...
Samnuha_Tights     = {'Name': 'Samnuha Tights', 'STR':38+10, 'DEX':6+10, 'VIT':15, 'AGI':30, 'INT':28, 'MND':16, 'CHR':8, 'Accuracy':15, 'Ranged Accuracy':15, 'Haste':6, 'Store TP':7, 'DA':3, 'TA':3,'Jobs':[]}
Jokushu_Haidate    = {'Name': 'Jokushu Haidate', 'STR':29, 'DEX':35, 'VIT':15, 'AGI':21, 'INT':30, 'MND':17, 'CHR':11, 'Haste':20, 'Crit Rate':4,'Jobs':[]}
Malignance_Tights  = {'Name': 'Malignance Tights', 'STR':28, 'DEX':0, 'VIT':17, 'AGI':42, 'INT':26, 'MND':19, 'CHR':12, 'Accuracy':50, 'Ranged Accuracy':50, 'Magic Accuracy':50, 'Haste':9, 'Store TP':10, 'PDL':0.05,'Jobs':[]}
...
Nyame_Flanchard  = {'Name': 'Nyame Flanchard', 'Name2': 'Nyame Flanchard R30', 'STR':43, 'DEX':0, 'VIT':30, 'AGI':34, 'INT':44, 'MND':32, 'CHR':24, 'Accuracy':40, 'Attack':30+35, 'Haste':3, 'Weaponskill Damage':0+0.12, 'Magic Accuracy':40, 'Magic Attack':30, 'Ranged Accuracy':40, 'Ranged Attack':30+35,'DA':0+6,'Jobs':[]}
Mpaca_Hose       = {'Name': 'Mpaca\'s Hose', 'Name2': 'Mpaca\'s Hose R30', "STR":49, "DEX":0, "VIT":32, "AGI":25, "INT":32,"MND":19,"CHR":19,"Accuracy":40+15,"Attack":40+30,"Magic Accuracy":40+15,"Haste":9,"TA":4,"Crit Rate":6,'PDL':0+0.08,'Jobs':[]}
Tatenashi_Haidate  = {'Name': 'Tatenashi Haidate', 'Name2': 'Tatenashi Haidate R15', 'STR':45+10, 'DEX':0+10, 'VIT':25+10, 'AGI':15+10, 'INT':23+10, 'MND':12+10, 'CHR':10+10,'Accuracy':0+60,'Attack':31,'Haste':5,'Store TP':7,'TA':0+3,'Jobs':[]}
Ryuo_Hakama_A  = {'Name': 'Ryuo Hakama +1', 'Name2': 'Ryuo Hakama +1 A', 'STR':29+12, 'DEX':0+12, 'VIT':15, 'AGI':21, 'INT':30, 'MND':17, 'CHR':11,'Accuracy':0+20,'Attack':33,'Ranged Attack':33, 'Haste':5,'Store TP':8,'DA':4,'Jobs':[]}
Rao_Haidate_B  = {'Name': 'Rao Haidate +1', 'Name2': 'Rao Haidate +1 B', 'STR':46+12, 'DEX':0+12, 'VIT':15, 'AGI':21, 'INT':30, 'MND':31, 'CHR':8, 'Attack':43+20, 'Haste':6, 'Store TP':8,'Jobs':[]}
Wakido_Haidate = {'Name': 'Wakido Haidate +3', 'STR':44, 'DEX':0, 'VIT':29, 'AGI':25, 'INT':37, 'MND':26, 'CHR':20, 'Accuracy':49, 'Attack':40, 'Ranged Attack':40, 'Haste':5, 'Store TP':9, 'Weaponskill Damage':0.1,'Jobs':[]}
Nyame_Flanchard  = {'Name': 'Nyame Flanchard', 'Name2': 'Nyame Flanchard R25', 'STR':43, 'DEX':0, 'VIT':30, 'AGI':34, 'INT':44, 'MND':32, 'CHR':24, 'Accuracy':40, 'Attack':30+30, 'Haste':3, 'Weaponskill Damage':0+0.11, 'Magic Accuracy':40, 'Magic Attack':30, 'Ranged Accuracy':40, 'Ranged Attack':30+30,'DA':0+5,'Jobs':[]}
Mpaca_Hose       = {'Name': 'Mpaca\'s Hose', 'Name2': 'Mpaca\'s Hose R25', "STR":49, "DEX":0, "VIT":32, "AGI":25, "INT":32,"MND":19,"CHR":19,"Accuracy":40+10,"Attack":40+25,"Magic Accuracy":40+10,"Haste":9,"TA":4,"Crit Rate":6,'PDL':0+0.07,'Jobs':[]}
...
Malignance_Boots    = {'Name': 'Malignance Boots', 'STR':6, 'DEX':40, 'VIT':12, 'AGI':49, "INT":0, 'MND':15, 'CHR':40, 'Accuracy':50, 'Ranged Accuracy':50, 'Magic Accuracy':50, 'Haste':3, 'Store TP':9, 'PDL':0.02, 'Jobs':[]}
...
Nyame_Sollerets   = {'Name': 'Nyame Sollerets', 'Name2': 'Nyame Sollerets R30', 'STR':23, 'DEX':26, 'VIT':24, 'AGI':46, 'INT':25, 'MND':26, 'CHR':38, 'Accuracy':40, 'Attack':30+35, 'Haste':3, 'Weaponskill Damage':0+0.11, 'Magic Accuracy':40, 'Magic Attack':30, 'Ranged Accuracy':40, 'Ranged Attack':30+35,'DA':0+5, 'Jobs':[]}
Mpaca_Boots       = {'Name': "Mpaca\'s Boots", 'Name2': "Mpaca\'s Boots R30", "STR":28,"DEX":32,"VIT":23,"AGI":34,"INT":0,"MND":11,"CHR":28,"Accuracy":40+10,"AttacK":40+30,"Magic Accuracy":40+15,"Haste":3,"TA":3,"Crit Rate":3,"Magic Attack":0+45, 'Jobs':[]}
Tatenashi_SuneAte   = {'Name': 'Tatenashi Sune-ate', 'Name2': 'Tatenashi Sune-ate R15', 'STR':16+10, 'DEX':19+10, 'VIT':16+10, 'AGI':32+10, 'INT':0+10, 'MND':5+10, 'CHR':19+10,'Accuracy':0+60,'Haste':3,'Store TP':7,'TA':0+3, 'Jobs':[]}
...
Nyame_Sollerets   = {'Name': 'Nyame Sollerets', 'Name2': 'Nyame Sollerets R25', 'STR':23, 'DEX':26, 'VIT':24, 'AGI':46, 'INT':25, 'MND':26, 'CHR':38, 'Accuracy':40, 'Attack':30+30, 'Haste':3, 'Weaponskill Damage':0+0.10, 'Magic Accuracy':40, 'Magic Attack':30, 'Ranged Accuracy':40, 'Ranged Attack':30+30,'DA':0+4, 'Jobs':[]}
Mpaca_Boots       = {'Name': "Mpaca\'s Boots", 'Name2': "Mpaca\'s Boots R25", "STR":28,"DEX":32,"VIT":23,"AGI":34,"INT":0,"MND":11,"CHR":28,"Accuracy":40+10,"AttacK":40+25,"Magic Accuracy":40+10,"Haste":3,"TA":3,"Crit Rate":3,"Magic Attack":0+40, 'Jobs':[]}
