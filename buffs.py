...
brd = {'Minuet': {'Attack': [32+25, 3.2], 'Ranged Attack': [32+25, 3.2]},
        ...
        'Sword Madrigal': {'Accuracy': [45, 4.5], 'Ranged Accuracy': [45, 4.5]},
        'Blade Madrigal': {'Accuracy': [60, 6], 'Ranged Accuracy': [60, 6]},
        'Advancing March': {'Haste': [1+108./1024, 11.8/1024]},
        'Victory March': {'Haste': [1+163./1024, 16.25/1024]},
        'Honor March': {'Haste': [1+126./1024, 12./1024], 'Attack': [168, 16], 'Ranged Attack': [168, 16], 'Accuracy': [42, 4], 'Ranged Accuracy': [42, 4]}}
